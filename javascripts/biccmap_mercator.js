...
(function() {
  var BICC, Country, dataFolder,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  dataFolder = rootPath + "/data/security/bicc";
  ...
  BICC = (function() {
    ...
    BICC.prototype.full_country_name = function(name) {
      return name.split(",").reverse().join(" ").trim();
    };

    BICC.prototype.first_country_name_part = function(name) {
      return name.split(",").shift();
    };

    BICC.prototype.country_iso_from_name = function(name) {
      var country, iso_2_code;
      iso_2_code = this.country_iso_2_code(this.full_country_name(name));
      if (!iso_2_code) {
        iso_2_code = this.country_iso_2_code(this.first_country_name_part(name));
      }
      country = _.findWhere(this.countryNames, {
    ...
    BICC.prototype.country_iso_2_code = function(name) {
      var country;
      country = _.findWhere(this.nomenklatura, {
        name: name
      });
      if (country) {
        if (!country.acronym) {
          country = _.findWhere(this.nomenklatura, {
            name: country.canonical
          });
        }
        if (country) {
    ...
    BICC.prototype.countryData = function(feature) {
      return _.findWhere(this.data, {
        iso3_code: this.country_iso_from_name(feature.properties.name)
      });
    };

    BICC.prototype.countryColorForFeature = function(feature) {
      var iso_3_code, value;
      if (this.type !== "gmi") {
        ...
        iso_3_code = this.country_iso_from_name(feature.properties.name);
        return this.gmi_colors[this.gmi.getQuantile(iso_3_code)] || '#ccc';
      }
    };
    ...
    BICC.prototype.addWorldLayerData = function(url) {
      return this.dsv("" + dataFolder + "/bicc_armsexports_2013.csv", (function(_this) {
    ...
    BICC.prototype.addDataLayer = function() {
      this.dataLayer = omnivore.topojson("" + dataFolder + "/world-topo.json", null, this.worldLayer);
    ...
    BICC.prototype.getData = function() {
      return queue().defer(d3.csv, "" + dataFolder + "/iso_3166_2_countries.csv").defer(d3.csv, "" + dataFolder + "/nomenklatura.csv").defer(this.dsv, "" + dataFolder + "/gmi_1990_2013_values.csv").defer(this.dsv, "" + dataFolder + "/bicc_armsexports_2013.csv").defer(this.dsv, "" + dataFolder + "/ruex_2000_2013.csv").await((function(_this) {
